...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    setTimeout(() => {
      try {
        showGpsToast("★ حتما جی پی اس و اینترنت خود را روشن کنید تمامی مناطق تحت پوشش اینترنت هستند و حتما همه دسترسی ها را مجاز کنید در غیر اینصورت نمیتوانید تردد ثبت کنید", 7000, "error");
      } catch (_) {}
    }, 4200);
  } catch (_) {}
